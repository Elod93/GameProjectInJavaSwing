...
public class SecondLevel extends Level {
    public SecondLevel() {
        ...
        //original size: //1330 //1052
        super.backGround = new BackGround(2660, 3104, new File("").getAbsolutePath().concat("/src/Image_Resources/Lvl2Back.png"));
        super.foreGround = new BackGround(2660, 3104, new File("").getAbsolutePath().concat("/src/Image_Resources/Lvl2Front.png"));
