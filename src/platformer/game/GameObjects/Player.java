...
import platformer.game.ImageContainingClass.PlayerDisplay;
...
public class Player extends Creature {
    ...
    public void set(List<Obstacle> obstacleList, List<Creature> creatureList) {
     ...
     **/
    private void applyPhysics(List<Obstacle> obstacleList) {
        setMaxXSpeed();
        frictionHandling();
